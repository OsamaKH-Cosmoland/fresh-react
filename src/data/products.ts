...
export const PRODUCTS: CatalogProduct[] = [
  {
    ...
    desc: "Soothing lavender and sweet almond oil calm the skin while mica powder adds a soft glow.",
    descAr: "اللافندر المهدئ وزيت اللوز الحلو يهدئان البشرة بينما يمنح مسحوق الميكا توهجاً ناعماً.",
    size: "100g",
    price: 75,
    compareAtPrice: 109,
  ...
  },
  {
    ...
    desc: "Infused with damask rose for a velvety cleanse and lingering floral aura.",
    descAr: "مُعزّز بالورد الدمشقي لتنظيف مخملي وعطر زهري يدوم.",
    size: "100g",
    price: 75,
    compareAtPrice: 109,
    discountPercentage: 30,
  ...
  },
  {
    ...
    desc: "An argan and jojoba blend that seals cuticles for mirror-like gloss without weight.",
    descAr: "مزيج من الأرجان والجوجوبا يُغلق القشرة لتوهج يشبه المرآة دون ثقل.",
    size: "30ml",
    price: 139,
    compareAtPrice: 199,
    discountPercentage: 30,
  ...
  },
  {
    ...
    desc: "Lightweight elixir powered by rosemary essential oil and castor oil to fortify roots.",
    descAr: "إكسير خفيف يدعم الجذور بزيت إكليل الجبل العطري وزيت الخروع.",
    size: "30ml",
    price: 149,
    compareAtPrice: 215,
    discountPercentage: 30,
  ...
  },
  {
    ...
    title: "Hand Balm",
    titleAr: "بلسم اليدين",
    desc: "Fast-absorbing restorative balm that cushions hands with shea and plant butters.",
    descAr: "بلسم مُرمّم سريع الامتصاص يلين اليدين بزبدة الشيا والزبدات النباتية.",
    size: "30ml",
    price: 179,
    compareAtPrice: 259,
    discountPercentage: 30,
