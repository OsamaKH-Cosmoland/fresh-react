...
export const ritualBundles: RitualBundle[] = [
  {
    ...
    tagline: "Wind down with buttery hydration and lavender serenity.",
    taglineAr: "اختتمي يومك بترطيب زبدي وسكينة اللافندر.",
  ...
  },
  {
    ...
    descriptionAr: "روتين شعر من خطوتين لدعم النمو ولمسة نهائية لامعة مضادة للهيشان.",
    featured: true,
    products: [
