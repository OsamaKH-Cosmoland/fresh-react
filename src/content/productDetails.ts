...
export const PRODUCT_DETAIL_CONFIGS: ProductDetailContent[] = [
  {
    ...
    defaultVariantId: "body-balm-50ml",
    heroSummaryBullets: [
  ...
  },
  {
    ...
    defaultVariantId: "hand-balm-50ml",
    heroSummaryBullets: [
